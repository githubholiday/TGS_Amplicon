...
qiime_biom:
	...
	${QIIME2_DIR}/biom convert -i ${infile} -o ${outdir}/$(prefix).biom  --to-hdf5 --table-type="OTU table"
	${QIIME2_DIR}/qiime tools import --input-path ${outdir}/$(prefix).biom --type 'FeatureTable[Frequency]' --input-format BIOMV210Format --output-path ${outdir}/$(prefix).qza
