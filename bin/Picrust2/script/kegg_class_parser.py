...
class Parse_Html():
	...
	def get_class1( self, line):
		#<h4 id="metabolism">1. Metabolism</h4>
		tmp = line.rstrip().split('>')
		meta = tmp[2].split('<')[0]
		return meta
	
	def get_class12( self, line):
		tmp = line.rstrip().split('>')
