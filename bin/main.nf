...
process write_log{
  conda (params.enable_conda ? "/annoroad/data1/software/bin/miniconda/envs/TGS_16s_pbtools" : null)
...
process cutadapt {
  conda (params.enable_conda ? "/annoroad/data1/software/bin/miniconda/envs/TGS_16s_qiime_2023" : null)
...
// HTML report
process html_rep {
  conda (params.enable_conda ? "/annoroad/data1/software/bin/miniconda/envs/TGS_16s_pbtools_vis" : null)
